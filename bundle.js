...
/*-----------------------------------------------------------------------------
  LOADING FONT
-----------------------------------------------------------------------------*/
var links=['https://fonts.googleapis.com/css?family=Josefin+Slab',
...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/esova-isidora1992', startPage)
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/esova-isidora1992">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
        <a href="http://isidorazdrakanovic992@gmail.com">
